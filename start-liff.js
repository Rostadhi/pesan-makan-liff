...
function displayIsInClientInfo() {
    if (liff.isInClient()) {
        ...
        document.getElementById('isInClientMessage').textContent = 'Dibuka di LINE.';
    } else {
        document.getElementById('liffLoginButton').classList.add('hidden');
        ...
        document.getElementById('isInClientMessage').textContent = 'Dibuka di Browser External.';
    }
}
...
function registerButtonHandlers() {
    document.getElementById('openWindowButton').addEventListener('click', function() {
        liff.openWindow({
            url: ' https://recipemakanan.herokuapp.com/', // GANTI DENGAN URL HEROKUAPP KALIAN
            external: true
        });
    });
    ...
    document.getElementById('pesan').addEventListener('click', function() {
        ...
        if(!liff.isInClient()) {
            ...
            var totalmakan, totalmakan2, totalminumf, totalminum2, totalHarga;
            ...
            .then(profile => {
                liff.sendMessages([{
                    'type': 'text',
                    'text': `Halo ${profile.displayName}, \n\nTerimakasih sudah memesan, \nbener  pesanan sudah ok ya, pesanannya adalah sebagai berikut : \n\n* ${totalmakan} Ayam Geprek\n* ${totalmakan2} Ayam Bakar\n* ${totalminum} Enjoy Drink Variant Squidward\n* ${totalminum2} Enjoy Drink Variant Patrick\n\nTotal : Rp. ${totalHarga}\n\nPesanan Anda Sedang Diproses, \n\nMohon ditunggu ya :)`
                }]).then(function() {
                    window.alert("Pesanan Makanan masuk");
                }).catch(function(error) {
